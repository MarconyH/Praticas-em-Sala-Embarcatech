...
/**
 * @file dht22.h
 * @brief Interface do driver para sensor DHT22/AM2302
 * 
 * Este arquivo define a interface pública para comunicação com o sensor
 * de temperatura e umidade DHT22 (também conhecido como AM2302) usando
 * o Raspberry Pi Pico.
 * 
 * O DHT22 é um sensor digital que fornece leituras de:
 * - Temperatura: -40°C a 80°C com precisão de ±0.5°C
 * - Umidade: 0-100% com precisão de ±2%
 */
